...
1. Run `python "${CLAUDE_PLUGIN_ROOT}/scripts/sync-ledger.py"` to refresh normalized project state.
...
5. Re-run `python "${CLAUDE_PLUGIN_ROOT}/scripts/validate-schemas.py"` after changing dashboard data fixtures or schema-backed JSON.
