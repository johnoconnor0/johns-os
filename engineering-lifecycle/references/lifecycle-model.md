...
- Expected artifacts: `.project/docs/engineering/<initiative-id>/discovery-brief.md`
...
- Expected artifacts: `.project/docs/engineering/<initiative-id>/prd.md`
...
- Expected artifacts: `.project/docs/engineering/<initiative-id>/app-flow.md`, `screen-inventory.md`
...
- Expected artifacts: `.project/docs/engineering/<initiative-id>/system-map/system-map.md`
...
- Primary skill: `create-technical-design-document`
- Expected inputs: system map, constraints, current codebase, operational requirements.
- Expected artifacts: `.project/docs/engineering/<initiative-id>/technical-design-document.md`, ADR candidates in `.project/.engineering/decisions/`
...
- Expected artifacts: `.project/docs/engineering/<initiative-id>/data/entity-model.md`, `erd.mmd`
...
- Expected artifacts: `.project/docs/engineering/<initiative-id>/api/api-contract.md`
...
- Primary skill: `create-engineering-plan`
- Expected inputs: PRD, UX flow, system map, architecture plan, data model, API contract.
- Expected artifacts: `.project/docs/engineering/<initiative-id>/engineering-plan.md`, `task-breakdown.md`
...
- Primary skill: none. The dashboard rebuilds itself: `scripts/sync-ledger.py` runs on
  every edit and again at the end of a turn, so `dashboards/` is always current
  without a skill invocation. Use `eng-life build-dashboard` to force a rebuild.
- Expected inputs: lifecycle artifacts, action-item ledger, open questions, release notes, monitoring outputs.
