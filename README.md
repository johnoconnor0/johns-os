...
| Plugin | Version | Role |
| --- | --- | --- |
| `engineering-lifecycle` | 0.9.0 | Structured discovery, requirements, UX, design systems, architecture, data modelling, API contracts, implementation, review, testing, release, and repository hygiene. Also issue surfacing and provider-agnostic tracker sync. |
| `business-development` | 0.2.0 | Interview-first Service Outline generation and updating. |
| `ai-utilities` | 0.2.0 | Claude Code extension authoring/review, and a plan-derived completion audit with its resolver. |
